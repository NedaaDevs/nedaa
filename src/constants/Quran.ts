...
// TODO(quran-gate): remove at 2.10.0 — once the reader ships the content DB is always
// installed, and Listen can read surah metadata from it again.
// Static per-surah reference data so Listen needs no content DB: it only streams audio, and
// these values are immutable. Indexed by surah number; index 0 is a placeholder to align
// with SURAH_NAMES.
...
// TODO(quran-gate): remove at 2.10.0 (see SURAH_AYAH_COUNTS).
export const SURAH_REVELATION_PLACES: readonly RevelationPlace[] = [
